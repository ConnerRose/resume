...
\begin{itemize}
  \item Designed and implemented \textbf{virtual memory manager} in
        \textbf{C++}, capable of servicing concurrent malloc/mmap requests
  \item Wrote a scheduler and threading library in \textbf{C++}, including
        \textbf{mutexes} and \textbf{condition variables}, with
        \textbf{multi CPU support}
\end{itemize}
