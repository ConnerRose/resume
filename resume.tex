...
% {Software Engineer}{}
% \begin{itemize}
%     \item Designed and delivered curriculum to club members,
%           supporting their preparation for software engineering interviews
% \end{itemize}
...
\section{Projects}
\subheading{Instagram Clone}{}{January -- February 2024}
{Python, HTML/CSS, JavaScript, Flask, React, Jinja, SQLite}{}
\begin{itemize}
    \item Developed social media web app,
          implemented server-side rendering with \textbf{Flask}
          and client-side rendering with \textbf{React}.
\end{itemize}
